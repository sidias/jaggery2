...
public class JaggeryBindImpl extends JSObject {
    ...
    private static Object ContextifyScriptImpl(){
        return initObject("JaggeryContextify");
    ...
    private static Object nativesImpl() {
        return initObject("JaggeryNatives");
    }

    private static Object FSImpl() {
        return initObject("JaggeryFs");
    }
