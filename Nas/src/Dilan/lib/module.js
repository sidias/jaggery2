...
Module.prototype.compile = function(content, fileName) {
	...
	var Script = jaggery.bind('contextify').contextifyScript;
 	...
 	fn(this.exports, require, this, fileName);
...
Module.Main = function () {
    ...
    /*for (var i = 0; i < 1000 ; i += 1) {
      ...
      print(globalVar)   */
    vm.runInNewContext('','var foo = {age:23};foo.age = 36;print(foo.age)');
	var compiledScript = vm.compileScript('','var foo = {age:23};foo.age = 36; print(foo.age) ');
	print(Object.prototype.toString.call(compiledScript))
	vm.runScripts(compiledScript);
